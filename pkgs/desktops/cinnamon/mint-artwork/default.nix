...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    urls = [
      ...
      "https://web.archive.org/web/20221126020521/http://packages.linuxmint.com/pool/main/m/mint-artwork/mint-artwork_${version}.tar.xz"
    ];
    hash = "sha256-QP+o+aJFWs0bYAsczE/CvmByh/5K2bCYMUkiRSp9t2Y=";
  };
